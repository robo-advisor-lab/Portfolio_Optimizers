...
print("\nContents of 'params_cache':")
for key in params_cache:
    print(f'{key}: {params_cache[key]}')

print("\nContents of 'live_cache':")
for key in cache:
...
def create_app():
    ...
    async def run_model(seed=20):
        ...
        cached_data = {"results": results, "graph_1": graph_json_1, "graph_2": graph_json_2,"graph_3":graph_json_3,"graph_4":graph_json_4,"graph_5":graph_json_5,'graph_6':graph_json_6}
